...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    List<Product> findProductsByCreditor(final Member creditor);

    List<Product> findProductsByDebtorGroupInOrCreditor(final List<MemberGroup> memberGroups, final Member creditor);

    List<Product> findProductsByCreditorAndCreationDateGreaterThanEqual(final Member creditor, final LocalDate creationDate);
